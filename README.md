...
# arxiv2026_review_quality_estimation
[![Arxiv](https://img.shields.io/badge/Arxiv-YYMM.NNNNN-red?style=flat-square&logo=arxiv&logoColor=white)](https://put-here-your-paper.com)
[![License](https://img.shields.io/github/license/UKPLab/arxiv2026-review-quality-estimation)](https://opensource.org/licenses/Apache-2.0)
[![Python Versions](https://img.shields.io/badge/Python-3.9-blue.svg?style=flat&logo=python&logoColor=white)](https://www.python.org/)
[![CI](https://github.com/UKPLab/arxiv2026-review-quality-estimation/actions/workflows/main.yml/badge.svg)](https://github.com/UKPLab/arxiv2026-review-quality-estimation/actions/workflows/main.yml)
...
To import classes/methods of `arxiv2026_review_quality_estimation` from inside the package itself you can use relative imports: 
...
```py
from arxiv2026_review_quality_estimation import BaseClass # Notice how I omit the file name
from arxiv2026_review_quality_estimation.subpackage import SubPackageClass # Here it's necessary because it's a subpackage
...
This is how you can use `arxiv2026_review_quality_estimation` from command line:

```bash
$ python -m arxiv2026_review_quality_estimation
```
