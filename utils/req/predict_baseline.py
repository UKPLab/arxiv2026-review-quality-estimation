# File copied from https://github.com/UKPLab/pragtag2023/blob/f0f5a9bb20eca8314e9c85b59cb1680ec0858a5b/code/baseline/predict_baseline.py
...
for batch_inputs in tqdm(inputs, desc="Iterating over input"):
    ...
    predictions += [{"sid": batch_inputs["sid"][i], "label": iCLASS_MAP[batch_predictions[i].item()]} for i in range(batch_size if len(batch_inputs["sid"]) == batch_size else len(batch_inputs["sid"]))]
